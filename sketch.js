...
// These 6 lines of code and line 15 was adapted from https://www.perplexity.ai/search/detta-ar-min-kod-i-3-olika-js-5jNMQYX1TguHEQfhCCBuwQ?0=d#0 Accessed: 11-10-2025
let handpose;
let video;
let hands = [];
let lastX = null;
...
function setup() {
  ...
  // These 4 lines of code was adapted from https://www.perplexity.ai/search/detta-ar-min-kod-i-3-olika-js-5jNMQYX1TguHEQfhCCBuwQ?0=d#0 Accessed: 11-10-2025
...
function draw() {
  ...
  // These 15 lines of code was adapted from https://www.perplexity.ai/search/detta-ar-min-kod-i-3-olika-js-5jNMQYX1TguHEQfhCCBuwQ?0=d#0 Accessed: 11-10-2025
  ...
  if (hands.length > 0 && hands[0].index_finger_tip) {
    ...
    if (lastX !== null) {
      ...
      rotationSpeed = lerp(rotationSpeed, dx * 0.02, 0.3);
    }
    lastX = x;
  } else {
...
// These 2 lines of code was adapted from https://www.perplexity.ai/search/detta-ar-min-kod-i-3-olika-js-5jNMQYX1TguHEQfhCCBuwQ?0=d#0 Accessed: 11-10-2025
